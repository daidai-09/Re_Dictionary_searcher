...
THEMES = {
    "Dark": {
        ...
        "link_fg": "#00FFFF",
        "clear_btn_bg": "#440000", "clear_btn_fg": "#FF8888" # クリアボタン用
    },
    "Light": {
        ...
        "link_fg": "#0000FF",
        "clear_btn_bg": "#FFDDDD", "clear_btn_fg": "#FF0000" # クリアボタン用
    }
}
...
class ReDicSearcherApp:
    ...
    def clear_search(self):
        ...
        self.refresh_list()
        # 検索欄にフォーカスを戻す（続けて入力しやすいように）
        if self.current_mode == "read":
            self.entry_search.focus_set()

    def jump_to_word_filter(self, word):
        """リンク: 検索ボックスに単語を入れてフィルタ"""
        self.entry_search.delete(0, tk.END)
